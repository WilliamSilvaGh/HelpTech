...
app.MapPost("/ocorrencia/adicionar", (HelpTechContext context, ClaimsPrincipal user, OcorrenciaAdicionarRequest ocorrenciaAdicionarRequest) =>
{
    ...
    try
    {
        ...
        var ocorrencia = new Ocorrencia(
            ...
            ocorrenciaAdicionarRequest.Hora,
            usuarioLogadoId
            );
...
app.MapGet("/usuario/listar", (HelpTechContext context, ClaimsPrincipal user) =>
{
    SetarDadosToken(user);
...
app.MapPut("/usuario/alterar-visibilidade/{usuarioId}", (HelpTechContext context, ClaimsPrincipal user, Guid usuarioId) =>
{
    try
    {
...
app.MapDelete("/usuario/{usuarioId}", (HelpTechContext context, Guid usuarioId, ClaimsPrincipal user) =>
{
    SetarDadosToken(user);
